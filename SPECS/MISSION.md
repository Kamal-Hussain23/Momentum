...
- The landing page must have one clear Call to Action (CTA) — not two, not three.
  > *Interpretation, agreed 2026-09-18:* "one CTA" means **one single conversion
  > action** — "Join the Waitlist" — which may repeat in standard page placements:
  > navbar, hero form, and footer. If a different action is ever added, the founder
  > decides which one wins; the rest must be removed.
